...
class _MyHomePageState extends State<Master> {
  bool monVal=false;
  @override
    ...
    return Scaffold
      (
        appBar: new AppBar(
          ...
          title: new Text('MT',style: TextStyle(fontSize: 18.0,color: Colors.white)),
          //   centerTitle: true,
                    ...
                    new Row(
                      children: <Widget>[
                        ...
                        new Flexible(
                          child: CheckboxListTile(
                            controlAffinity: ListTileControlAffinity.leading,
                            title: Text('Auto Login',style: TextStyle(fontSize: 12.0)),
                            value: monVal,
                            onChanged: (bool value) {
                              setState(() {
                                monVal = value;
